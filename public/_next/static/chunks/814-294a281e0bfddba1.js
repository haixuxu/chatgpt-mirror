          ...
          function n() {
            ...
            return (
              ...
              ((e = t.call(
                ...
                ((o = a),
                o &&
                (o.startsWith("Rate limit reached for") ||
                  o.startsWith("End-user exceeded rate-limit"))
          ...
          return (
                ...
                return (0, h.__generator)(this, function(h) {
                  switch (h.label) {
                    case 0:
                      return [
                        4,
                        fetch(e, (o = (0, r.Z)({ credentials: "include" }, t))),
                      ];
                    case 1:
                      if ((a = h.sent()).status >= 500) throw new y();
            ...
            (e.upload = function(e, t) {
              ...
              return (
                n.append("file", t),
                this.fetch(
                  "".concat(T, "/conversation/").concat(e, "/upload"),
                  {
                    method: "POST",
            ...
            (e.generateTitle = function(e, t, n) {
              return this.fetch(
                "".concat(T, "/conversation/gen_title/").concat(e),
                {
                  method: "POST",
                  headers: (0, r.Z)(
                    { "Content-Type": "application/json" },
              ...
              return (0, o.Z)(function() {
                ...
                return (0, h.__generator)(this, function(d) {
                  return (
                    ...
                    (0, u.L)("".concat("/backend-api", "/conversation"), {
                      method: "POST",
                      credentials: "include",
                      headers: (0, r.Z)(
                        { "Content-Type": "application/json" },
                      ...
                      onmessage: function(e) {
                        if ("[DONE]" === e.data)
                          s.abort(), n({ finish_reason: "stop" });
                        else if ("ping" === e.event);
                        else
                          try {
                            var t = JSON.parse(e.data);
                            if (t.error) throw new y(t.error.message);
                            n({
                              message: t.message,
                              threadId: t.conversation_id,
                            });
                          } catch (o) {
                            if ((0, l.TV)(o)) throw new y(o.message);
                          }
                      },
                      onerror: function(e) {
                      ...
                      (0, a.Z)(e, m) || (0, a.Z)(e, y) || console.error(e);
                    }),
                    [2, s]
                  );
                });
            ...
            (e.submitMessageFeedback = function(e) {
              return this.fetch(
                "".concat(T, "/conversation/message_feedback"),
                {
                  method: "POST",
                  headers: (0, r.Z)(
                    { "Content-Type": "application/json" },
            ...
            (e.getAccountStatus = function(e, t, n) {
              ...
              if (t) {
                ...
                try {
                  for (
                    var d, l = Object.entries(t)[Symbol.iterator]();
                    !(s = (d = l.next()).done);
                    s = !0
                  ) {
                    var p = (0, c.Z)(d.value, 2),
                      f = p[0],
                      g = p[1];
            ...
            (e.getPlugins = function(e) {
              var t = e.offset,
                ...
                o = e.isInstalled,
                i = e.accessToken,
                a = { offset: t.toString(), limit: n.toString() };
            ...
            (e.updatePluginUserSettings = function(e) {
              var t = e.pluginId,
                ...
                o = e.accessToken;
              return this.fetch(
                "".concat(T, "/aip/p/").concat(t, "/user-settings"),
                {
                  method: "PATCH",
                  headers: (0, r.Z)(
                    { "Content-Type": "application/json" },
            ...
            (e.setPluginUserHttpToken = function(e) {
              var t = e.id,
                ...
                o = e.accessToken;
              return this.fetch(
                "".concat(T, "/aip/p/").concat(t, "/user-settings/http-auth"),
                {
                  method: "POST",
                  headers: (0, r.Z)(
                    { "Content-Type": "application/json" },
            ...
            (e.setPluginServiceHttpToken = function(e) {
              var t = e.id,
                ...
                o = e.accessToken;
              return this.fetch(
                "".concat(T, "/aip/p/").concat(t, "/http-auth"),
                {
                  method: "POST",
                  headers: (0, r.Z)(
                    { "Content-Type": "application/json" },
            ...
            (e.getPageMetadata = function(e) {
              var t = e.url;
              return this.fetch(
                "".concat(T, "/opengraph/tags?url=").concat(t),
                {
                  method: "GET",
                  headers: (0, r.Z)(
                    { "Content-Type": "application/json" },
